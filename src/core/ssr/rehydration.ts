...
import { HTMLBrowserDOMApi, type DOMApi } from '@/core/dom-api';
import { SVGBrowserDOMApi } from '@/core/svg-api';
import { MathMLBrowserDOMApi } from '@/core/math-api';
import { cleanupFastContext, provideContext, RENDERING_CONTEXT, API_FACTORY_CONTEXT } from '../context';
import { NS_SVG, NS_MATHML } from '@/core/namespaces';
import { isRehydrationScheduled, setRehydrationScheduled } from './rehydration-state';
