...
import { PdfDemo } from './renderers/PdfDemo.gts';
  ...
  return <template>
    <div class='text-white p-6 max-w-6xl mx-auto'>
      ...
      <p class='text-slate-400 mb-8'>
        Demonstrating the framework's ability to render to different targets: Canvas, SVG, MathML, Three.js (WebGL), and PDF.
